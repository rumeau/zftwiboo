...
class Badge extends AbstractStyleHelper
{
    /**
     * @var string   HTML template
     */
    public $template = "<span class=\"badge badge-%s\">%s</span>";
    ...
    /**
     * Retrive the object to call overloaded methods, or render the badge
     * 
     * @param string     Text to be displayed as content
     * @param string     Style Type to render
     * @return \ZFTwiBoo\View\Helper\Badge
     */
